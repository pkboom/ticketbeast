            ...
            <div class="card p-xs-6">
                <form action="{{ route('backstage.concert-messages.store', $concert) }}" method="POST">
                    ...
                    <div class="form-group {{ $errors->first('subject', 'has-error')}}">
                        ...
                        <input name="subject" class="form-control" value="{{ old('subject') }}"> @if($errors->has('subject'))
                        <p class="help-block">
                    ...
                    <div class="form-group {{ $errors->first('message', 'has-error')}}">
                        ...
                        <textarea class="form-control" name="message" rows="10">{{ old('message') }}</textarea> @if($errors->has('message'))
                        <p class="help-block">
